...
// ------------------------------------------------------------
// WICHTIG:
// Empfaenger-Adresse fuer Kontaktformular-Mails.
// ------------------------------------------------------------

$siteEmail = "kontakt@kunden-navigator.de";
...
switch ($_SERVER['REQUEST_METHOD']) {
    ...
    case 'POST':
        ...
        // Empfaengeradresse (nutzt die oben definierte Mail)
        $recipient = $siteEmail;
